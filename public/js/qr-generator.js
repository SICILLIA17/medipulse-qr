// MediPulse QR Code Generator (Pure JavaScript Standalone Engine)
// Generates scannable QR Code Level M/H SVG and Canvas elements

(function(root) {
  // Simple, robust QR Code generator using standard QR matrix encoding
  ...
  root.MediPulseQR = {
    renderSVG: function(text, options) {
      ...
      return '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 ' + boxSize + ' ' + boxSize + '" width="' + size + '" height="' + size + '" shape-rendering="crispEdges">' +
